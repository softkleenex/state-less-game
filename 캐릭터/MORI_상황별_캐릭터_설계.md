...
MORI를 일반적인 사이버펑크 AI 소녀가 아니라, `MEMORY:// LOCAL ARCHIVE`에서 한 출처의 기억만 관리하는 **로컬 기억 사서이자 브라우저 데몬**으로 보이게 한다.
...
**컴퓨터와 색인 정리를 좋아해 장난스럽게 말을 거는 20대 초반의 흑발 기억 사서. 플레이어가 페이지를 떠나거나 자신을 지우려 할 때만 조용한 집착이 드러난다.**
